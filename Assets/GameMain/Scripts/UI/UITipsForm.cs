...
namespace StarForce
{
    public class UITipsForm : UGuiForm
    {
        [SerializeField]
        ...
        private void RefreshConfirmText(string confirmText)
        {
            ...
            {
                confirmText = GameEntry.Localization.GetString(Constant.Localization.TipsConfirmButton);
            }
        ...
        private void RefreshCancelText(string cancelText)
        {
            ...
            {
                cancelText = GameEntry.Localization.GetString(Constant.Localization.TipsCancelButton);
            }
        ...
        private void RefreshOtherText(string otherText)
        {
            ...
            {
                otherText = GameEntry.Localization.GetString(Constant.Localization.TipsOtherButton);
            }
