...
namespace StarForce
{
    public class ProcedureChangeScene : ProcedureBase
    {
        ...
        protected override void OnUpdate(ProcedureOwner procedureOwner, float elapseSeconds, float realElapseSeconds)
        {
            ...
            Type procedureType = Type.GetType(drScene.Procedure);
            ...
            if (null != procedureType)
            {
                ...
                Log.Warning("Can not change state, scene procedure '{0}' error, from sceen '{1}", drScene.Procedure.ToString(), drScene.Id);
        }
